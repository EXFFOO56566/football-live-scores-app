...
import 'package:football3/Provider/match.dart';
...
class ThreenextMatchPage extends StatefulWidget {
  const ThreenextMatchPage({Key? key}) : super(key: key);

  @override
  State<ThreenextMatchPage> createState() => _ThreenextMatchPageState();
}

class _ThreenextMatchPageState extends State<ThreenextMatchPage> {
