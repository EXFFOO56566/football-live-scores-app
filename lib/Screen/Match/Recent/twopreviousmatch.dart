...
class TwoPreviousMatchPage extends StatefulWidget {
  const TwoPreviousMatchPage({Key? key}) : super(key: key);

  @override
  State<TwoPreviousMatchPage> createState() => _TwoPreviousMatchPageState();
}

class _TwoPreviousMatchPageState extends State<TwoPreviousMatchPage> {
    ...
    try {
      await Provider.of<MatchProvider>(context, listen: false).getfixturematch(
          date: DateFormat("yyyy-MM-dd").format(
              DateTime(dateTime.year, dateTime.month, dateTime.day - 2)));
      setState(() {
